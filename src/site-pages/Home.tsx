...
const needOptions = [
  ...
  { id: "technique", label: "Technique", hint: "Décontam. / hottes", icon: Wrench, image: images.environnement, text: "Protocoles adaptés aux zones critiques, aux surfaces et au niveau de risque." },
];

const services = [
  { n: "01", title: "Bureaux", group: "Premium", text: "Espaces de travail nets, réguliers, prêts dès le matin.", image: images.premium },
  { n: "02", title: "Copropriétés", group: "Premium", text: "Halls, cages d’escalier et parties communes tenus avec discrétion.", image: images.detail },
  { n: "03", title: "Vitrerie", group: "Premium", text: "Lumière retrouvée sur baies, cloisons et accès difficiles.", image: images.hero },
  { n: "04", title: "Remise en état", group: "Premium", text: "Après chantier, déménagement ou période intensive.", image: images.detail },
  { n: "05", title: "Après sinistre", group: "Environnement", text: "Méthode, sang-froid et organisation sur situations sensibles.", image: images.environnement },
  { n: "06", title: "Décontamination", group: "Environnement", text: "Protocoles adaptés au site, aux surfaces et au niveau de risque.", image: images.environnement },
  { n: "07", title: "Désinfection", group: "Environnement", text: "Traitement ciblé des zones sensibles avant leur remise en usage.", image: images.detail },
  { n: "08", title: "Logements insalubres", group: "Environnement", text: "Prise en charge discrète et structurée des situations complexes.", image: images.environnement },
  { n: "09", title: "Assainissement", group: "Environnement", text: "Retour à des conditions saines et maîtrisées.", image: images.detail },
  { n: "10", title: "Hottes professionnelles", group: "Environnement", text: "Dégraissage des installations et zones critiques.", image: images.environnement },
];

const steps = [
  ["01", "Écoute", "Vous décrivez le lieu, les usages et la contrainte."],
  ["02", "Cadrage", "Nous proposons le niveau d’intervention adapté."],
  ["03", "Exécution", "Équipes discrètes, planning clair, contrôle terrain."],
  ["04", "Suivi", "Ajustements selon le ressenti du site et vos attentes."],
];
...
const faqs = [
  {
    q: "Délai de devis",
    a: "Sous 24 à 48h. On revient avec un cadrage clair : besoin, fréquence, niveau d’intervention.",
  },
  {
    q: "Zone d’intervention",
    a: "Basés à Saint-Germain-en-Laye. Paris et Île-de-France, selon le site et le planning.",
  },
  {
    q: "Horaires & discrétion",
    a: "Passages calés sur votre activité : matin, soirée ou week-end — pour ne pas perturber le lieu.",
  },
  {
    q: "Premium ou Environnement",
    a: "Premium = tenue régulière des lieux. Environnement = situations techniques ou sensibles.",
  },
  {
    q: "Engagement",
    a: "Pas de complexité inutile. On cadre d’abord, puis on choisit ponctuel ou récurrent.",
  },
];
      ...
      <main>
          ...
          <div className="container relative z-10 grid gap-9 pb-10 pt-28 sm:gap-12 sm:pb-14 sm:pt-32 lg:min-h-[790px] lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:gap-16 lg:pb-16 lg:pt-36">
            <div className="max-w-[660px]">
              <div className="hero-reveal flex items-center gap-3" style={{ animationDelay: "60ms" }}>
                ...
                <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#a8d8ea]">Propreté & interventions techniques</p>
              </div>
              <h1 className="hero-reveal mt-6 max-w-[760px] text-[clamp(2.7rem,12vw,4.8rem)] font-extrabold leading-[.98] tracking-[-0.055em] sm:mt-7" style={{ animationDelay: "140ms" }}>
                La propreté <span className="text-[#67b9ff]">bien organisée.</span>
              </h1>
              <p className="hero-reveal mt-7 max-w-[520px] text-[16px] leading-7 text-white/65" style={{ animationDelay: "230ms" }}>LVMR Group organise l’entretien régulier et les interventions spécialisées pour les entreprises, copropriétés et établissements d’Île-de-France.</p>
          ...
          <div className="container">
            <div className="flex flex-col justify-between gap-7 lg:flex-row lg:items-end">
              <div>
                ...
                <h2 className="mt-4 max-w-[760px] text-[clamp(2.1rem,4vw,3.5rem)] font-extrabold leading-[1.04] tracking-[-.05em]">Une entreprise. Deux expertises terrain.</h2>
              </div>
              <p className="max-w-[360px] text-[15px] leading-7 text-[#424242]">Un même niveau d’organisation pour l’entretien régulier et les interventions nécessitant une technicité spécifique.</p>
            </div>
        ...
        <section id="expertises" className="bg-[#f5f5f5] py-16 sm:py-20">
          <div className="container">
            <div className="flex flex-col justify-between gap-7 lg:flex-row lg:items-end">
              <div>
                <div className="flex items-center gap-4"><p className="eyebrow">Nos interventions</p><span className="rounded-full bg-[#e5f3f7] px-3 py-1 text-[10px] font-extrabold uppercase tracking-[.1em] text-[#4caac9]">10 expertises</span></div>
        ...
        <section id="realisations" className="bg-[#f5f5f5] pb-20 sm:pb-28">
          <div className="container">
            <div className="mb-10 flex flex-col justify-between gap-5 sm:flex-row sm:items-end"><div><p className="eyebrow">Sur le terrain</p><h2 className="mt-3 text-[clamp(2rem,4vw,3.7rem)] font-extrabold leading-[1] tracking-[-.05em]">Des espaces prêts à vivre.</h2></div><p className="max-w-[320px] text-[14px] leading-6 text-[#424242]">Chaque lieu impose son rythme. Notre travail consiste à le respecter tout en élevant son niveau de tenue.</p></div>
            <div className="grid auto-rows-[230px] gap-4 sm:auto-rows-[280px] md:grid-cols-12">
              {[
                [images.detail, "Remise en état", "Espace professionnel · Paris", "md:col-span-7 md:row-span-2"],
                [images.environnement, "Intervention spécialisée", "Site technique · Yvelines", "md:col-span-5"],
                [images.hero, "Entretien premium", "Bureaux & accueil · IDF", "md:col-span-5"],
        ...
        {/* TESTIMONIALS — cinematic quote, no cards */}
        <section id="temoignages" className="bg-[#f5f5f5] py-16 sm:py-20">
          <div className="container">
          <div className="relative min-h-[600px] overflow-hidden rounded-[24px] bg-[#202020] text-white sm:min-h-[680px] sm:rounded-[28px] lg:min-h-[72vh]">
          {testimonials.map((item, index) => (
            <img
              ...
              className={`absolute inset-0 h-full w-full object-cover transition-opacity duration-700 ${
                activeTestimonial === index ? "opacity-45" : "opacity-0"
              }`}
            />
          ))}
          <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(32,32,32,.94)_18%,rgba(32,32,32,.55)_58%,rgba(32,32,32,.78)_100%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_70%_40%,rgba(76,170,201,.28),transparent_55%)]" />

          <div className="relative flex min-h-[600px] flex-col justify-between px-5 py-10 sm:min-h-[680px] sm:px-10 sm:py-16 lg:min-h-[72vh] lg:px-14 lg:py-20">
            <div className="flex items-center justify-between gap-4">
              <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#4caac9]">Voix clients</p>
              <p className="text-[12px] font-semibold tabular-nums text-white/45">
                0{activeTestimonial + 1} — 0{testimonials.length}
              </p>
            </div>

            <div className="mx-auto max-w-[980px] py-9 text-center sm:py-16">
              <p
                key={`tag-${currentTestimonial.name}`}
                className="voice-fade text-[12px] font-bold uppercase tracking-[0.16em] text-[#4caac9]"
              >
                {currentTestimonial.tag}
              </p>
              <blockquote
                key={`quote-${currentTestimonial.name}`}
                className="voice-fade mt-6 text-[clamp(1.85rem,5.2vw,4.1rem)] font-extrabold leading-[1.05] tracking-[-0.05em]"
              >
                {currentTestimonial.quote}
              </blockquote>
              <p
                key={`meta-${currentTestimonial.name}`}
                className="voice-fade mt-8 text-[14px] text-white/55 sm:text-[15px]"
              >
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
              <div className="flex flex-wrap gap-x-6 gap-y-2">
                {testimonials.map((item, index) => (
                  <button
                    ...
                    className={`relative pb-2 text-[13px] font-bold tracking-[-0.02em] transition ${
                      activeTestimonial === index ? "text-white" : "text-white/40 hover:text-white/70"
                    }`}
                  >
                    {item.name}
                    <span
                      className={`absolute inset-x-0 bottom-0 h-[2px] origin-left bg-[#4caac9] transition ${
                        activeTestimonial === index ? "scale-x-100" : "scale-x-0"
                      }`}
                    />
                  </button>
                ))}
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="text-[13px] font-bold text-white/55 transition hover:text-white"
                >
                  Préc.
                </button>
