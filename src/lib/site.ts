...
export const premiumServices: ServiceItem[] = [
  ...
  service({ slug: "coproprietes", group: "premium", title: "Copropriétés et résidences", shortTitle: "Copropriétés", kicker: "LVMR Premium", image: imageSet.detail, description: "Entretien des halls, cages d’escalier, paliers, ascenseurs, vitrages accessibles et locaux communs.", intro: "LVMR Premium entretient les parties communes des immeubles et résidences. La fréquence et le cahier des charges sont établis en fonction de la configuration et de la fréquentation du site.", points: ["Halls, cages d’escalier et paliers", "Ascenseurs et locaux communs", "Vitrages accessibles et zones de circulation", "Fréquence et cahier des charges adaptés au site"], idealFor: ["Copropriétés", "Résidences", "Syndics", "Bailleurs"] }, 2),
